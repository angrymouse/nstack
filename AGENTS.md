...
subtitles when they do not carry real product or workflow meaning. Tiny labels
above headings are a common antipattern, especially when they repeat the page
idea or sit inside a bordered card, shadowed pill, or standalone surface for
decoration. Labels such as `LIVE`, `Open Source`, or section eyebrows should
earn their place; otherwise remove them and let the heading or body copy do the
work.
