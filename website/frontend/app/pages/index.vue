      ...
      <section class="hero-section">
        <div class="hero-grid mx-auto flex max-w-6xl flex-col items-center px-5 pb-12 pt-28 text-center md:px-8 md:pb-16 md:pt-28">
          <div class="mx-auto flex max-w-6xl flex-col items-center">
            ...
            <h1 class="mx-auto max-w-[32rem] font-display text-5xl font-extrabold leading-tight tracking-normal text-zinc-50 md:text-7xl">
              Develop scalable, opinionated,
              <br>
              <span class="pastel-text">AI-focused</span> full stack apps.
            </h1>
